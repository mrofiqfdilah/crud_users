        ...
        <div class="card-body">
            <form action="{{ route('admin.update', $users->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control" placeholder="Masukkan nama" value="{{ $users->name ?? '' }}">
                </div>
                <div class="mb-3">
                    <label for="username" class="form-label">Username</label>
                    <input type="text" name="username" class="form-control" placeholder="Masukkan username" value="{{ $users->username ?? '' }}">
                </div>
                <div class="mb-3">
                    <label for="email" class="form-label">Email</label>
                    <input type="email" name="email" class="form-control" placeholder="Masukkan email" value="{{ $users->email ?? '' }}">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select name="level" class="form-control">
                        ...
                        <option value="author" {{ $users->level == 'author' ? 'selected' : '' }}>Author</option>
                    </select>
                </div>
                <div class="mb-3">
